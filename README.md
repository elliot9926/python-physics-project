...
An n-body physics simulator written in Python
...
# Installation
Requirements: Python 3.10.x, VPython 7.6.5, NumPy 2.4.2

Clone the repository and create a venv with the correct version of Python and the required packages
# Usage
