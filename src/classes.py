...
class Simulation:
        ...
        def step(self, dt): # Steps towards the next moment in time
             self.integrator.step(self.bodies, self.system.gravity_system)
...
class  VelocityIntegrator:  # Verlet integrator, I still need to read more about this but it seems like the standard
     def __init__(self, dt):
          ...
          def step(self, bodies, gravity_system):
               dt = self.dt
